...
// On mobile only the shield icon shows (wordmark hidden) to save space.
export default function Logo({ className = '' }) {
  return (
    <span className={`flex items-center gap-2 ${className}`}>
      <svg viewBox="0 0 48 48" className="h-7 w-7 sm:h-8 sm:w-8 shrink-0" aria-hidden="true">
        <defs>
      ...
      <span className="hidden sm:inline text-lg font-extrabold tracking-tight text-foreground leading-none">
